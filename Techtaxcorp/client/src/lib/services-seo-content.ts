...
export const softwareServiceSections: ServiceSeoSection[] = [
  {
    ...
    intro:
      "TechTaxCorp builds secure, role-based web applications tailored to approvals, documents, reporting, and day-to-day operations—so your team replaces spreadsheets with one dependable system.",
    benefits: [
