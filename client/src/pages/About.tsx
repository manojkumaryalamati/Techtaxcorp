...
export default function About() {
  useSEO({
    title: "About TechTaxCorp | Ledger Software & Application Development Company",
    description: "TechTaxCorp is a ledger software and application development company building VahanBooks, MySiteWorks, and custom business applications—mobile apps, dashboards, websites, and SaaS products for growing teams.",
    canonicalPath: "/about",
    keywords: ["TechTaxCorp", "about TechTaxCorp", "ledger software company", "business software development", "VahanBooks", "MySiteWorks"],
  });
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground">
              TechTaxCorp designs and ships practical, mobile-first software—our products include VahanBooks for
      ...
      <section className="py-16 sm:py-24 bg-accent/30">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">These core values guide everything we do at TechTaxCorp.</p>
          </div>
