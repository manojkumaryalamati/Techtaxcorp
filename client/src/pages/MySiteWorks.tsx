...
export default function MySiteWorks() {
  useSEO({
    ...
    keywords: ["MySiteWorks", "TechTaxCorp", "construction project management software", "construction expense tracking", "site management app", "builder software India"],
  });
  ...
  const softwareJsonLd = {
    ...
    description: "MySiteWorks, designed and developed by TechTaxCorp, helps construction teams manage projects, expenses, progress, documents, and payments from one simple app.",
        ...
        <section className="border-t bg-muted/15 py-12 sm:py-16" aria-labelledby="mysiteworks-why-heading">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              ...
              <Card><CardContent className="p-6"><h3 className="font-semibold">Designed and developed by TechTaxCorp</h3><p className="mt-2 text-sm text-muted-foreground">One accountable product team—from discovery to releases you can plan around.</p></CardContent></Card>
            </div>
          </div>
        </section>
