...
export default function VahanBooks() {
  useSEO({
    ...
    keywords: [
      "VahanBooks",
      "TechTaxCorp",
      "transport khata software",
      "trip management software",
      "truck fleet software India",
      "transport ledger",
      "fleet khata app",
    ],
  });
  ...
  const softwareJsonLd = {
    ...
    description:
      "VahanBooks, designed and developed by TechTaxCorp, helps transport businesses manage trips, payments, khata, invoices, and reports easily.",
  ...
  return (
    <Layout>
      ...
      <article>
        <section className="border-b bg-muted/20 py-12 sm:py-16" aria-labelledby="vahanbooks-hero-heading">
        ...
        <section className="py-12 sm:py-16" aria-labelledby="vahanbooks-capabilities-heading">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <h2 id="vahanbooks-capabilities-heading" className="font-serif text-2xl font-bold sm:text-3xl">
              What VahanBooks helps you run
            </h2>
            <p className="mt-3 max-w-3xl text-muted-foreground">
              Built for day-to-day transport workflows—clear enough for crews, structured enough for owners and
              brokers.
            </p>
        ...
        <section className="border-t bg-muted/15 py-12 sm:py-16" aria-labelledby="vahanbooks-why-heading">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <h2 id="vahanbooks-why-heading" className="font-serif text-2xl font-bold sm:text-3xl">
              Why teams choose VahanBooks
            </h2>
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold">Khata-first clarity</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Party and supplier balances stay visible—so collections and follow-ups do not depend on scattered
                    notebooks.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold">Trip operations in one flow</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Trips, PODs, and documents stay attached to the job—reducing disputes and lost paperwork.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold">Built by TechTaxCorp</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Product ownership, roadmap, and engineering sit with one team—so improvements stay aligned with
                    field reality.
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="py-12 sm:py-16" aria-labelledby="vahanbooks-cta-heading">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            ...
            <h2 id="vahanbooks-cta-heading" className="mt-4 font-serif text-2xl font-bold">
              See if VahanBooks fits your fleet or brokerage
            </h2>
            <p className="mt-3 text-muted-foreground">
              Tell us how you run trips and khata today—we will suggest a practical rollout and what to automate first.
            </p>
