...
export function useSEO(options: UseSEOOptions) {
  ...
  useEffect(() => {
    ...
    const canonical = !skipCanonical && canonicalPath ? absoluteUrl(canonicalPath) : null;
    if (canonical) {
  ...
  }, [title, description, canonicalPath, skipCanonical, keywords, ogTitle, ogDescription, ogImagePath, ogType, twitterCard, robots, author]);
}
